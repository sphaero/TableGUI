...
compile:
	...
	$(GCOMPILER) -g -Wall -o ./Build/test main.c -I$(INC_) -I$(INC_freetype2) -I$(LOCAL_INC) -L$(LIB_) -L$(LIB_freetype2) -L$(LOCAL_LIB) main.o GUI.o GUI_widget.o GUI_font.o GUI_box.o GUI_contentbox.o GUI_button.o GUI_splitter.o GUI_treeview.o GUI_checkbox.o GUI_tabset.o GUI_scrollbar.o -lbasicutils -lglfw -lfreetype -lcairo $(LIBS) $(CFLAGS)
	./Build/test